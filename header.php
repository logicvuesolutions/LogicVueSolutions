			...
			<div class="row" >
				<div class="col" >
					<a href="<?php bloginfo('url'); ?>" id="site_id" >
						<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 2448 675" style="enable-background:new 0 0 2448 675;" xml:space="preserve">
						<style type="text/css">
							.st0{fill:#6D6D6D;}
							.st1{fill:#0C41B2;}
